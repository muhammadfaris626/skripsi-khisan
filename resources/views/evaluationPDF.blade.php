        ...
        <div class="column-full padding-1 text-size-sm">
            <table>
                ...
                <tbody>
                    <tr>
                        <td></td>
                        <td class="text-size-lg font-bold">20%</td>
                        <td></td>
                        <td colspan="3">
                            Sangat menguasai pengetahuan jabatan dan dapat pula menerapkan dengan sempurna. Dalam tugas sempurna dan dapat diandalkan
                        </td>
                        <td colspan="3">
                            Menguasai pengetahuan jabatan dengan baik sekali, kadang perlu diarahkan dalam aspek tugas yang kompleks atau tidak rutin
                        </td>
                        <td colspan="3">
                            Menguasai pengetahuan jabatan dengan baik tetapi masih perlu dibantu dalam beberapa aspek pelaksanaan tugasnya
                        </td>
                        <td colspan="3">
                            Memenuhi prasyarat minimum pengetahuan jabatan, masih perlu dibantu dan diarahkan dalam pelaksanaan tugasnya.
                        </td>
                        <td colspan="3">
                            Tidak memenuhi prasyarat minimum jabatan, tidak menguasai sebagian besar aspek tugas.
                        </td>
                    </tr>
                </tbody>
            </table>
